...
public final class NoticeRenderer {
  ...
  public static void render(
    ...
    pose.m_85836_();
    pose.m_85837_(x + metrics.width(), y + metrics.height() / 2.0, 0.0);
    pose.m_252781_(Axis.f_252403_.m_252977_((float)motion.rotation()));
    pose.m_85841_((float)motion.scale(), (float)motion.scale(), 1.0F);
    pose.m_85837_(-metrics.width(), -metrics.height() / 2.0, 0.0);
